...
import { waLink, WA_MSG_DEFAULT, SOCIALS } from '../config'
      ...
      >
          ...
          {SOCIALS.map((s, i) => (
            <li key={s.key} role="none">
              ...
              >
                ...
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-ivory text-ink shadow-[0_6px_28px_-8px_rgba(18,16,14,0.5)] ring-1 ring-ink/8 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover/item:scale-105 group-active/item:scale-95">
        ...
        <div className="flex items-center gap-2.5">
          ...
          >
            ...
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-ivory/10 transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] group-hover/wa:scale-105 group-hover/wa:bg-ivory/20">
