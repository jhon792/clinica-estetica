          ...
          <div className="flex items-center gap-3">
            {socials.map(s => (
              <a
                ...
                rel="noreferrer"
                aria-label={s.label}
                className="w-11 h-11 rounded-full border border-[#2a2420] flex items-center justify-center transition-all duration-300 group"
                style={{ '--brand': s.color }}
                onMouseEnter={e => {
                  e.currentTarget.style.borderColor = s.color
                  e.currentTarget.style.backgroundColor = s.color + '20'
                }}
                onMouseLeave={e => {
